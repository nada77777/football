...
const TopScoreProfile = ({ clubPlayer, display }) => {
    ...
    return (
        <section className={display === 'squadDisplay' ? `${styles.squad}` : `${styles.profile}`}>
            <div className={styles.profileInner}>
                <div className={styles.playerInfo}>
                    <img className={styles.playerImg} src={display === 'squadDisplay' ? clubPlayer.photo : (player ? player.photo : defaultImg)} alt="player_img" />
                    <div className={styles.playerInfoText}>
                        <p>{display === 'squadDisplay' ? clubPlayer.name : (player && player.name)}</p>
                        <p>{display === 'squadDisplay' ? `number: ${clubPlayer.number}` : (player && player.birth.date)}</p>
                        <p>age: {display === 'squadDisplay' ? clubPlayer.age : (player && player.age)}</p>
                        <p>{display === 'squadDisplay' ? `position: ${clubPlayer.position}` : (player && `${player.height} / ${player.weight}`)}</p>
                    </div>
                </div>
                {display === 'squadDisplay' ? '' : (<div className={styles.team}>
